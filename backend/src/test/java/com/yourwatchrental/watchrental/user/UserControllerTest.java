...
public class UserControllerTest {
    ...
    void shouldGetUsers() throws Exception
    {
        ...
        when(userService.getUsers(any(UserFilterCriteriaRequestDTO.class), any(Pageable.class)))
                .thenReturn(page);
        ...
        verify(userService)
                .getUsers(any(UserFilterCriteriaRequestDTO.class), any(Pageable.class));
    }
    ...
    void shouldUpdatePassword() throws Exception
    {
        ...
        mockMvc.perform(
                patch("/users/me/password", userId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request))
