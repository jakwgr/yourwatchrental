...
import { BranchRequestDTO } from '../../models/branch/branch-request.dto';
import { BranchStatusUpdateRequest } from '../../models/branch/branch-status-update-request.dto';
@Service()
export class BranchesService {
    ...
    updateBranch(id: string, request: BranchRequestDTO)
    {
        return this.http.put<BranchResponseDTO>(`api/branches/${id}`, request);
    }

    updateBranchStatus(id: string, request: BranchStatusUpdateRequest)
    {
